...
const FightActions = (props) =>
{
    ...
    return (
        <div className="fight_actions">
            ...
            <button onClick={props.attack} onMouseOut={attackMouseOut} onMouseMove={attackMouseIn}>Attack <img src={sword}/></button>
            <button onClick={props.defense}>Defense <img src={shield}/></button>
        </div>
    )
